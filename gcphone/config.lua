...
Config.valetPrice = 10000
Config.uberPriceMultiplier = 1.5 -- Means if items price $4, 4 * 1.5 = 6
Config.uberTipMin = 100 -- If player is a lucky get min tip on deliver
Config.uberTipMax = 200 -- If player is a lucky get max tip on deliver
...
Config.uberItems = {
	[1] = {["item"] = "bandage", ["name"] = "Bandage", ["price"] = 100},
	[2] = {["item"] = "hamburger", ["name"] = "Hamburger", ["price"] = 100},
	[3] = {["item"] = "water", ["name"] = "Water", ["price"] = 100},
}